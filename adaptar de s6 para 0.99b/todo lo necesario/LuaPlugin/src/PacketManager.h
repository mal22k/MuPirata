...
// CPacketManager: cifrado/descifrado de packets del protocolo MU Online.
// Portado literal del Main_EX603 (PacketManager.h/cpp).
// Claves en Data\Enc1.dat (encriptar) y Data\Dec2.dat (desencriptar).
// Decrypt()/DecryptBlock() quedan reservados para el futuro hook de recepcion
// (on_packet); hoy solo se usan Encrypt/AddData/ExtractPacket (envio).
