...
int LuaGetObjectGuildNumber(lua_State* L) // OK
{
	...
	lua_pushinteger(L,gObj[aIndex].Guild->Index);
	return 1;
}
...
int LuaGetObjectGuildName(lua_State* L) // OK
{
	...
	lua_pushstring(L,gObj[aIndex].Guild->Name);
	return 1;
}
...
int LuaItemDropEx(lua_State* L) // OK
{
	...
	GDCreateItemSend(aIndex,aValue,bValue,cValue,dValue,eValue,fValue,gValue,hValue,iValue,((lValue==0)?aIndex:lValue),jValue,kValue);
...
int LuaItemGiveEx(lua_State* L) // OK
{
	...
	GDCreateItemSend(aIndex,0xEB,0,0,aValue,bValue,cValue,dValue,eValue,fValue,-1,gValue,hValue);
