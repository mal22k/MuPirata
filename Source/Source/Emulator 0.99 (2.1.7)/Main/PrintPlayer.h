...
void PrintDamageOnScreenHP(DWORD a, DWORD b, float* c, DWORD d);
void PrintDrawCircleHPMP(DWORD a, float b, float c, float d, float e, float f, float g, float h, float i, int j, int k, GLfloat l);
void PrintDrawCircleBP(DWORD a, float b, float c, float d, float e, float f, float g, float h, float i, int j, int k, GLfloat l);
