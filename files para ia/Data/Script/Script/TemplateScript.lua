...
BridgeFunctionAttach('OnMonsterDamaged','TemplateScript_OnMonsterDamaged')
...
BridgeFunctionAttach('OnPartyEntry','TemplateScript_OnPartyEntry')
BridgeFunctionAttach('OnPartyClose','TemplateScript_OnPartyClose')
...
function TemplateScript_OnMonsterDamaged(aIndex, bIndex, damage, finalDamage)
	-- ### Argument information: ###
	-- aIndex = Monster index (victim).
	-- bIndex = User index (attacker).
	-- damage = Calculated damage.
	-- finalDamage = Final damage applied to the monster.

	-- ### Bridge information: ###
	-- Called each time the monster receives damage.
end
...
function TemplateScript_OnPartyEntry(aIndex,index)
	-- ### Argument information: ###
	-- aIndex = User index.
	-- index = Party slot.

	-- ### Bridge information: ###
	-- Called after a user enters the party with a character.
end

function TemplateScript_OnPartyClose(aIndex,index)
	-- ### Argument information: ###
	-- aIndex = User index.
	-- index = Party slot.

	-- ### Bridge information: ###
	-- Called after a user leaves the party with a character.
end
