...
-- Cualquier modificación incorrecta puede resultar en errores, 
-- fallos o comportamientos inesperados en el juego.

-- WARNING: Modifying this file may affect the functionality of the game.
-- Any incorrect modification can result in errors, crashes, 
...
function BridgeFunction_OnMonsterDamaged(...)

	if BridgeFunctionTable["OnMonsterDamaged"] ~= nil then
	
		for _, func in ipairs(BridgeFunctionTable["OnMonsterDamaged"]) do
